...
* Three map modes: default, alliances, meganations
...
2. Install EarthMC Dynmap+ by [clicking here](https://github.com/3meraldK/earthmc-dynmap/releases/latest/download/userscript.user.js). It may be more tricky to get it working on mobile.

## Maintainability
The extension's maintainers aren't affiliated with EarthMC and responsible for archiving maps. Please keep in mind, that the extension may temporarily render unusable due to unexpected EarthMC or third-party updates. If that was the case, the maintainers would address potential problems sooner or later likely through the communications channel on [EarthMC Discord thread](https://discord.com/channels/219863747248914433/1047061595861286912).

## Screenshot
![image](https://github.com/user-attachments/assets/deb930ac-b803-4b72-af94-214c53203392)
